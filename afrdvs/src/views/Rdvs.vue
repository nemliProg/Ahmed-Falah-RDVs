...
export default {
  ...
  methods: {
    displayCalenderDays() {
      ...
      this.$refs.month.innerText =
        dateStringArray[1].split(" ")[0] + " " + dateStringArray[2];
      let daySquares = [];
      ...
      for (let i = 1; i <= pastDays + daysInCurrentMonth; i++) {
        ...
        if (i > pastDays) {
          ...
          if (
            i - pastDays == day &&
            firstDayOfTheMonth.getMonth() == month &&
            firstDayOfTheMonth.getFullYear() == year
          ) {
